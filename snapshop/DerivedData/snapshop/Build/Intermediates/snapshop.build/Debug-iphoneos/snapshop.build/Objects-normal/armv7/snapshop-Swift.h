...
SWIFT_CLASS("_TtC8snapshop11AppDelegate")
...
SWIFT_CLASS("_TtC8snapshop17CartTableViewCell")
...
SWIFT_CLASS("_TtC8snapshop18PageViewController")
@interface PageViewController : UIPageViewController <UIPageViewControllerDataSource>
@property (nonatomic, strong) ViewController * __nonnull cameraController;
@property (nonatomic, strong) CartViewController * __nullable cartController;
@property (nonatomic, strong) CheckoutViewController * __nullable checkoutController;
- (void)viewDidLoad;
- (void)showCart;
- (void)showCheckout;
...
SWIFT_CLASS("_TtC8snapshop14ViewController")
@interface ViewController : UIViewController <AVCaptureMetadataOutputObjectsDelegate, CNPPopupControllerDelegate>
@property (nonatomic, readonly, strong) AVCaptureSession * __nonnull session;
@property (nonatomic, strong) AVCaptureVideoPreviewLayer * __null_unspecified previewLayer;
@property (nonatomic, strong) UIView * __nonnull highlightView;
@property (nonatomic, strong) UIButton * __nonnull scannedItems;
@property (nonatomic, strong) UIButton * __nonnull checkout;
@property (nonatomic, strong) NSDictionary * __nonnull data;
@property (nonatomic, strong) CNPPopupController * __nullable popupController;
@property (nonatomic, strong) NSDictionary * __nonnull dictionary;
@property (nonatomic, strong) PageViewController * __nullable pvc;
@property (nonatomic, readonly, strong) Firebase * __null_unspecified ref;
- (void)showScannedItems;
- (void)showCheckout;
- (void)addTargetsToButtons;
- (void)addItem;
- (void)cancelItemInfo;
- (void)showItemInfo;
